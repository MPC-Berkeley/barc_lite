...
sym_input_stage = 0.5*(1e-1*(sym_u[ua_idx])**2 + 1e-1*(sym_u[us_idx])**2)
sym_input_term = 0.5*(1e-1*(sym_u[ua_idx])**2 + 1e-1*(sym_u[us_idx])**2)
...
mpc_controller = CA_NL_MPC(dyn_model, 
                            sym_costs, 
                            sym_constrs, 
...
mpc_controller.set_warm_start(u_ws, du_ws)
